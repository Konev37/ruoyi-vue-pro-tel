...
public class FireController {
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:firecreate')")
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:fireupdate')")
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:firedelete')")
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:firequery')")
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:fireexport')")
