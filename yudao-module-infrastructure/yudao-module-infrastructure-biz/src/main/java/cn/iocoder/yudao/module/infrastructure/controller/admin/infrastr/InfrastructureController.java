...
public class InfrastructureController {
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:infrastrcreate')")
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:infrastrupdate')")
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:infrastrdelete')")
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:infrastrquery')")
...
//    @PermitAll
    ...
    @PreAuthorize("@ss.hasPermission('infrastructure:infrastrexport')")
