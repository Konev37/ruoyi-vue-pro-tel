...
public class InfrastructureController {
    ...
    @PreAuthorize("@ss.hasPermission('base:infrastructure:create')")
    ...
    @PreAuthorize("@ss.hasPermission('base:infrastructure:update')")
    ...
    @PreAuthorize("@ss.hasPermission('base:infrastructure:delete')")
...
//    @PreAuthorize("@ss.hasPermission('base:infrastructure:query')")
    ...
    @PreAuthorize("@ss.hasPermission('base:infrastructure:export')")
